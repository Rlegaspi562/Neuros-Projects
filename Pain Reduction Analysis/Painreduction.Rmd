...
new_cleaned_inj_data <- cleaning_inj_data %>% 
  ...
  mutate(visit_date = as.Date(as.character(cleaning_inj_data$visit_date), "%m/%d/%y", tz = "UTC"))
?as.Date


  test <- cleaning_inj_data %>% as.Date(cleaning_inj_data$visit_date, format = "%m/%d/%y")

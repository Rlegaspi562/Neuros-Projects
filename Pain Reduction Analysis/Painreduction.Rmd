...
```{r}
pie <- ggplot(cleaned_data_19_21, aes(x = "", fill = factor(inj_location))) + 
  geom_bar(width = 1) +
  ...
  labs(fill="class", 
       x=NULL, 
       y=NULL, 
       title="Pie Chart Injection Location", 
       caption="Source: mpg")
  
pie + coord_polar(theta = "y", start=0)


df <- as.data.frame(table(cleaned_data$lido_pct_change_in_pain))
